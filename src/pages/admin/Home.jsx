  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-10">
        <h1 className="text-4xl text-white">Good morning, Edinson!</h1>
      ...
      <div className="bg-secondary-100 p-8 rounded-xl">
        <div className="hidden md:grid grid-cols-1 md:grid-cols-5 gap-4 mb-10">
          <h5>ID</h5>
          <h5>Description</h5>
          <h5>Status</h5>
          <h5>Date</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 bg-secondary-900 p-4 rounded-xl">
          ...
          <div>
            ...
            <p>My computer is not working</p>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 bg-secondary-900 p-4 rounded-xl">
          ...
          <div>
            <h5 className="md:hidden text-white font-bold mb-2">Status</h5>
            <span className="py-1 px-2 bg-blue-500/10 text-yellow-500 rounded-lg">
              In process
            </span>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 bg-secondary-900 p-4 rounded-xl">
          ...
          <div>
            <h5 className="md:hidden text-white font-bold mb-2">Status</h5>
            <span className="py-1 px-2 bg-green-500/10 text-yellow-500 rounded-lg">
              closed
            </span>
          </div>
          <div>
